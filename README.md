...
|[settingCollection](reference/word/settingcollection.md)|_Method_ > [add(key: string, value: object)](settingcollection.md#addkey-string-value-object)|Creates a new setting entry.|1.4|
